...
void cuci1(){
   ...
   do{
	...
	char nama[]={"1. Motor "};
			for(int a=0;a<strlen(nama);a++){
				textcolor(2);
				gotoxy(23+a,22);cprintf("%c ",nama[a]);Sleep(100);
      	}

      char nama2[]={"2. Mobil"};
      	for(int a=0;a<strlen(nama2);a++){
         	textcolor(2);
            gotoxy(83+a,22);cprintf("%c",nama2[a]);Sleep(100);
         }
...
void mobil(){
         ...
         background();
   		char nama1[]={"1. Mobil Sport"};
				for(int a=0;a<strlen(nama1);a++){
					textcolor(2);
					gotoxy(5+a,22);cprintf("%c ",nama1[a]);Sleep(100);
		   	}

         char nama2[]={"2. Mobil Keluarga"};
				for(int a=0;a<strlen(nama2);a++){
					textcolor(2);
					gotoxy(53+a,22);cprintf("%c",nama2[a]);Sleep(100);
		   	}
         char nama3[]={"3. Mobil TraveL"};
				for(int a=0;a<strlen(nama3);a++){
				textcolor(2);
				gotoxy(95+3+a,22);cprintf("%c ",nama3[a]);Sleep(100);
		   }
...
do{
      ...
      gotoxy(52,34);cprintf("Masukan Nominal : Rp. ");scanf("%d",&uang);
	   if(uang>cuci){
      	char kembali;
	   	uang=uang-cuci;
         gotoxy(52,35);cprintf("Kembalian : %d\n",uang);
...
void balik(){
char Balik;
	cprintf("Apakah Ingin Mencuci Kembali ? (y/t)");Balik=getche();
